...
<body>
    ...
    <div class="container">
        <form action="{{ route('mureedain.store') }}" method="POST" enctype="multipart/form-data">
            @csrf   
        <div class="form-container">
            <h1 class="text-center">BIO DATA FORM (MUREEDAIN)</h1>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="cnic" name="cnic" placeholder="Enter your CNIC number">
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="street" name="street" placeholder="Enter your street number">
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="tehsil" name="tehsil" placeholder="Enter your tehsil">
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="tel" class="form-control" id="contact_primary" name="contact_primary" placeholder="Enter your primary contact number">
            </div>

            <!-- Contact (Secondary) -->
            <div class="mb-3">
                <label for="contact_secondary" class="form-label">Contact (Secondary)</label>
                <input type="tel" class="form-control" id="contact_secondary" name="contact_secondary" placeholder="Enter your secondary contact number">
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="job_business" name="job_business" placeholder="Enter your job/business">
            </div>

            <!-- Nature of Job/Business -->
            <div class="mb-3">
                <label for="nature_of_job_business" class="form-label">Nature of Job/Business</label>
                <textarea class="form-control" id="nature_of_job_business" name="nature_of_job_business" rows="3" placeholder="Describe the nature of your job/business"></textarea>
            </div>

            <!-- Bayat Date -->
            <div class="mb-3">
                <label for="bayat_date" class="form-label">Bayat Date</label>
                <input type="date" class="form-control" id="bayat_date" name="bayat_date">
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="department_tdf" name="department_tdf" placeholder="Enter the department you work in">
            </div>

            <!-- Bayat By -->
            <div class="mb-3">
                <label for="bayat_by" class="form-label">Bayat By</label>
                <input type="text" class="form-control" id="bayat_by" name="bayat_by" placeholder="Enter the name of the person who initiated your bayat">
            </div>

            <!-- Filled By -->
            <div class="mb-3">
                <label for="filled_by" class="form-label">Filled By</label>
                <input type="text" class="form-control" id="filled_by" name="filled_by" placeholder="Enter the name of the person who filled this form">
            </div>

            <!-- Signature -->
            <div class="signature mb-3">
                <label for="signature" class="form-label">Signature</label>
                <input type="text" class="form-control" id="signature" name="signature" placeholder="Sign here (optional)">
            </div>
